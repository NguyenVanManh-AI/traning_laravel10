...
class CategoryService
{
    ...
    public function add(RequestCreateCategory $request)
    {
        ...
        try {
            ...
            $category = CategoryRepository::updateCategory($category->id, $data); // dùng trong repository hoặc code ở đây 
                ...
                foreach ($categories as $category) {
                    if ($category->thumbnail) {
                        ...
                        if (File::delete($category->thumbnail)) {
                            ...
                            return $this->responseError('Lỗi khi xóa tệp liên quan đến danh mục.');
                        }
                    }
                }
